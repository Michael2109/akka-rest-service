...
class DatabaseConnectorTest extends WordSpec with Matchers with ScalaFutures {
  ...
  "DatabaseConnector" should {
    ...
    "Add a license to the database" in {
      DatabaseConnector.addLicense(License(0, "Account Name 1", "12345", 1, 1))
    ...
    "Get a license by ID" in {
      ...
      DatabaseConnector.addLicense(License(0, "Account Name 1", "12345", 1, 1))
      DatabaseConnector.addLicense(License(0, "Account Name 2", "2345", 1, 1))
      DatabaseConnector.addLicense(License(0, "Account Name 3", "5432", 1, 1))
